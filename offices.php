...
<div id="log">
<a href="index.php">Home</a> | Outgoing Offices | <a href="doctype.php">Incoming File</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search Document Type..." autocomplete="off" />
<a rel="facebox" href="addoffice.php" id="add">Add Office</a>
</div>
